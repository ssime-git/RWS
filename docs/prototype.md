...
The durable LaunchAgent periodically reconnects eligible missing mounts, guided
by persistent Connect/Disconnect intent. It does not force-repair unresponsive
volumes. See the [automatic-remount contract](connection.md#automatic-remount-contract).
